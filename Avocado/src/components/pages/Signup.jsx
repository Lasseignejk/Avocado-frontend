...
const Signup = () => {
  ...
  const sendToSupabase = async (accountDetails) => {
    // write a  state hook that you set to true
    // set it to true
    const { CustomerEmail, Password } = accountDetails;
    ...
    console.log(user);
    // if they make it,set a global state value to the user who just logged in
